<?php include 'admin/db_connect.php'; 
	...
	$special = $conn->query("SELECT * FROM facilities");
	$ms_arr = array();
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Conference Rooms</h3>
	...
	<section class="page-section" id="doctors" >
        <div class="container">
        	<div class="card">
        			...
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<?php
								$s = $conn->query("SELECT * from facilities where id = ".$_GET['sid'])->fetch_array()['name'];
								?>
								<h2><b>Conference rooms with facilities such as <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				$cats = $conn->query("SELECT * FROM rooms_list ".$where." order by id asc");
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small>Room location: <b><?php echo $row['clinic_address'] ?></b></small></p>
						 <p><small>Contact #: <b><?php echo $row['contact'] ?></b></small></p>
						 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name']?>"><i class='fa fa-calendar'></i> Schedule</a></b></small></p>
						 <p><b>Facilities:</b></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $row['name']?>">BOOK</button>
					</div>
				</div>
    ...
    <script>
       ...
       $('.set_appointment').click(function(){
       	if('<?php echo isset($_SESSION['login_id']) ?>' == 1)
			uni_modal("Book a conference room in "+$(this).attr('data-name'),"set_appointment.php?id="+$(this).attr('data-id'),'mid-large')
		else{
