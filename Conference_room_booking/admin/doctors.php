					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<select name="specialty_ids[]" id="" multiple=""  class="custom-select browser-default select2">
									<option value=""></option>
									<?php 
									$qry = $conn->query("SELECT * FROM facilities order by name asc");
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $conn->query("SELECT * FROM rooms_list order by id asc");
								...
								<tr>
									...
									<td class="">
										 ...
										 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name']?>"><i class='fa fa-calendar'></i> Availability</a></b></small></p>
