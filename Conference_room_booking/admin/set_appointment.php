...
$doctor= $conn->query("SELECT * FROM rooms_list ");
	...
	if(isset($_GET['id'])){
	$qry = $conn->query("SELECT * FROM bookings_list where id =".$_GET['id']);
...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<form action="" id="manage-appointment">
			...
			<input type="hidden" name="doctor_id" value="<?php echo isset($_SESSION['login_room_id']) ? $_SESSION['login_room_id'] : ''; ?>">
				<?php else: ?>
