            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                        ...
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="index.php?page=doctors">Find a Room</a>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="index.php?page=doctors&sid=<?php echo $row['id'] ?>">
                            ...
                            <div class="portfolio-box-caption">
                                ...
                                <div class="project-category text-white">Find a conference room</div>
                            </div>
                        </a>
                    </div>
                    <?php endwhile; ?>
